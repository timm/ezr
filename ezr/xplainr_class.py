...
"""xplainr_class.py: rule generation from top signals
...
from ez_class     import Data,Num,Sym,Row,csv,adds,the,cast,main,shuffle,filename
from xplain_class import xplanTrain, signal, rowBin
